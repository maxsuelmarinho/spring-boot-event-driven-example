...
public class DateAggregate {
    ...
    public int getAvailableSeats() {
        int reservedSeats = reservations.values()
                .stream().mapToInt(r -> r.getSeats())
                .sum();
    ...
    public void apply(List<ReservationEvent> events) {
        events.stream().forEach(event -> {
            ...
            switch (eventData.getEventType()) {
                case CREATED:
                    ReservationCreatedData resCreated = (ReservationCreatedData) eventData;
                    ...
                    break;
                case CANCELLED:
                    ReservationCancelledData resCancelled = (ReservationCancelledData) eventData;
            ...
            setLastUpdatedOn(event.getCreateOn());
